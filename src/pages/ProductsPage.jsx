...
import { Search, Check, Wrench, X, ShoppingCart } from 'lucide-react';
  ...
  return (
    <>
                ...
                <div className="p-5 bg-white dark:bg-transparent">
                  ...
                  <div className="flex items-center justify-between">
                    {product.purchasable ? (
                      ...
                      <>
                        <span className="text-purple-600 dark:text-purple-400 font-semibold text-sm">Detaylar</span>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-3xl bg-white dark:bg-[#0a0e27] border border-gray-200 dark:border-purple-500/30 p-0">
          <VisuallyHidden>
                  ...
                  <div className="space-y-3">
                    {selectedProduct.features.map((feature, index) => (
                      <div key={index} className="flex items-start space-x-3">
                        <Check className={`w-5 h-5 flex-shrink-0 mt-0.5 ${selectedProduct.purchasable ? 'text-green-500' : 'text-green-500 dark:text-green-400'}`} />
