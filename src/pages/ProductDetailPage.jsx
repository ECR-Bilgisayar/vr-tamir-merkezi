        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-blue-200 text-sm font-medium">Ücretsiz Ön Değerlendirme</p>
                    <p className="text-blue-300/80 text-xs mt-1">Cihazınızı getirin, arızayı tespit edelim, fiyat teklifi sunalım.</p>
                  </div>
                </div>
              </div>
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-8 flex items-center">
              <Wrench className="w-8 h-8 mr-3 text-purple-400" />
              Tamir Hizmetlerimiz
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {product.repairTypes?.map((repair, index) => (
                <motion.div
                  ...
                  className="p-6 rounded-xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 hover:border-purple-500/50 transition-all group"
                >
                  ...
                  <p className="text-gray-400 text-sm mb-3">{repair.description}</p>
                  <div className="flex items-center justify-between pt-3 border-t border-white/5">
                    <span className="text-xs text-gray-500">Teslim Süresi</span>
                    <span className="text-sm text-purple-400 font-medium">{repair.duration}</span>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              <h2 className="text-2xl font-bold text-white mb-6">Destek Verdiğimiz Sorunlar</h2>
            ...
            <motion.div
              ...
              className="p-8 rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 backdrop-blur-sm"
            >
              <h2 className="text-2xl font-bold text-white mb-6">Tamir Süreci</h2>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="text-white font-semibold mb-1">Ön Değerlendirme</h3>
                    <p className="text-gray-400 text-sm">Cihazınızı getirin, arızayı tespit edelim</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 rounded-full bg-purple-500/20 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h3 className="text-white font-semibold mb-1">Fiyat Teklifi</h3>
                    <p className="text-gray-400 text-sm">Ücretsiz fiyat teklifi sunuyoruz</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 rounded-full bg-purple-500/20 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h3 className="text-white font-semibold mb-1">Onarım</h3>
                    <p className="text-gray-400 text-sm">Profesyonel ekibimiz tamir işlemini gerçekleştirir</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 rounded-full bg-purple-500/20 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h3 className="text-white font-semibold mb-1">Test & Teslim</h3>
                    <p className="text-gray-400 text-sm">Cihazınızı test edip size teslim ediyoruz</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="mt-16 p-12 rounded-3xl bg-gradient-to-br from-purple-500/20 to-blue-500/20 border border-purple-500/30 backdrop-blur-sm text-center"
          >
